        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <form method="post" action="{{ route('sale.create') }}" class="mt-6 space-y-6">
                        @csrf

                            <div>
                                <x-input-label for="client" :value="__('Cliente (opcional)')" />
                                <x-text-input id="client" name="client" type="text" class="mt-1 block w-full" autofocus autocomplete="client" :value="old('client')" />
                            ...
                            <div class='flex items-end gap-2'>
                                <div class='flex-grow'>
                                    ...
                                    <x-text-input id="installments_quantity" name="installments_quantity" type="number" min="1" max="24" step="1" class="mt-1 block w-full" :value='1'/>
                                </div>
                                <div>
